...
class ModelSolver:
    ...
    def solve(self):
        ...
        while iteration <= max_iter and wfmax > tol:
            (c_hat, Pf_hat, Pm_hat, pif_hat, pim_hat, pif_prime, pim_prime, Xf_prime, Xm_prime, D_prime, p_index, real_w_hat, X_prime, Xf_prod_prime, Xm_prod_prime, X_prod_prime, I_prime, output_prime, real_I_prime, sector_links, country_links) = generate_equilibrium(
        ...
        # store
        solution = ModelSol(
            w_hat=w_hat, c_hat=c_hat, Pf_hat=Pf_hat, Pm_hat=Pm_hat,
            pif_hat=pif_hat, pim_hat=pim_hat, pif_prime=pif_prime, pim_prime=pim_prime,
            Xf_prime=Xf_prime, Xm_prime=Xm_prime, X_prime=X_prime, p_index=p_index, real_w_hat=real_w_hat,
            D_prime=D_prime, Xf_prod_prime=Xf_prod_prime, Xm_prod_prime=Xm_prod_prime, X_prod_prime=X_prod_prime,
            I_prime=I_prime, output_prime=output_prime, real_I_prime=real_I_prime, sector_links=sector_links, country_links=country_links
        )
        self.model.sol = solution
